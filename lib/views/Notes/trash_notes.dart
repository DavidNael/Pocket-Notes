...
class TrashNotesView extends StatefulWidget {
  const TrashNotesView({Key? key}) : super(key: key);

  @override
  State<TrashNotesView> createState() => _TrashNotesViewState();
}

class _TrashNotesViewState extends State<TrashNotesView> {
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              return Scaffold(
                ...
                body: StreamBuilder(
                  stream: _notesService.trashNotes(ownerUserId: userId),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
